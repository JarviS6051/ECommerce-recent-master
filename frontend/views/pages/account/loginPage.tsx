...
const Login: NextPage = () => {
  ...
  const loginAuth = async (email: string, password: string) => {
    try {
      ...
      // Assuming the response contains the user's first name
      setFirstName(data.firstName || ""); // Set the first name if available
          ...
          <Row className="row">
            <Col xl="4" lg="6" md="8" className="offset-xl-4 offset-lg-3 offset-md-2">
              <div className="theme-card">
                ...
                <form className="theme-form">
                  <div className="form-group">
                    <Label htmlFor="emailLoginPage">Email</Label>
                    <Input
                      type="email"
                      value={email}
                  ...
                  <div className="form-group">
                    <Label htmlFor="passwordLoginPage">Password</Label>
                    <Input
                      type="password"
                      value={password}
